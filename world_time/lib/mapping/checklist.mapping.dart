...
class ChecklistMapping {
  dynamic MapServiceAddChecklist(ChecklistModel model) {
    ...
    var url = 'http://api.phanmemquocbao.com/api/Doituong/InsertObjects?p0=${checklist.category}&p1=${checklist.name}&p2=${checklist.content}&p3=${checklist.hour}&p4=${checklist.minutes}&p5=${checklist.current}&p6=${checklist.week}&tokenin=lethibaotran';
